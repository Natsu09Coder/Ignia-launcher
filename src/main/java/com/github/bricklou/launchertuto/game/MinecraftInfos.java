...
public class MinecraftInfos {
    public static  final String SERVER_NAME = "Ignia-launcher";
    ...
    public static final String CURSE_MODS_LIST_URL = "////ignir//minecraft-server/mods_list.json";
    public static final String MODS_LIST_URL = "////ignir//minecraft-server/mods_list.json";
}
